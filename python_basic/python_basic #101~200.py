...
answer = money.split(" ")
if answer[1] == "달러" :
    result = float(answer[0]) * 1167
elif answer[1] == "엔" :
    result = float(answer[0]) * 1.096
elif answer[1] == "유로" :
    result = float(answer[0]) * 1268
elif answer[1] == "위안" :
    result = float(answer[0]) * 171
print(result, "원")
...
#126
office = input("우편번호: ")
if int(office[2]) >= 0 and int(office[2]) < 3:
    print("강북구")
elif int(office[2]) >= 3 and int(office[2]) < 6 :
    print("도봉구")
else :
    print("노원구")
...
people = input(">> 주민등록번호: ")
mf = people.split("-")[1]
if int(mf[0]) == 1 or int(mf[0]) == 2 :
    print("남자")
else :
    print("여자")

#128
area = int(people.split("-")[1][1:3])
if 0 <= area <= 8 :
    print("서울 입니다.")
else :
    print("서울이 아닙니다.")
...
#129
number = input(">> 주민등록번호: ")
int(number[0]) * 2 + int(number[0]) * 2 + int(number[0]) * 2 +int(number[0]) * 2 + int(number[0]) * 2 + int(number[0]) * 2 + int(number[0]) * 2 + int(number[0]) * 2 + int(number[0]) * 2 + int(number[0]) * 2 + int(number[0]) * 2
